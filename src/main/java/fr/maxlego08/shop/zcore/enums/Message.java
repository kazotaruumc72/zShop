...
public enum Message {
    ...
    DESCRIPTION_LEVEL_ADD("Add shop levels to a player"),
    DESCRIPTION_LEVEL_REMOVE("Remove shop levels from a player"),
    ...
    LEVEL_ADD_SUCCESS("§a§e+%amount% §ashop level(s) given to §f%player%§a (now level §e%level%§a)."),
