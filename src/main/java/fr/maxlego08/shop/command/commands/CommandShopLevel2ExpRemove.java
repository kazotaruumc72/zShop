...
public class CommandShopLevel2ExpRemove extends VCommand {

    public CommandShopLevel2ExpRemove(ShopPlugin plugin) {
        super(plugin);
        this.setPermission(Permission.ZSHOP_LEVEL2_EXP_REMOVE);
        this.addSubCommand("expremove");
        this.setDescription(Message.DESCRIPTION_LEVEL2_EXP_REMOVE);
    ...
    protected CommandType perform(ShopPlugin plugin) {
        ...
        PlayerShopLevel2 playerLevel = manager.removeExp(target.getUniqueId(), amount);
        message(plugin, sender, Message.LEVEL2_EXP_REMOVE_SUCCESS,
