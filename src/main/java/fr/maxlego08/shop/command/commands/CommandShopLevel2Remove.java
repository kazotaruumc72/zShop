...
public class CommandShopLevel2Remove extends VCommand {

    public CommandShopLevel2Remove(ShopPlugin plugin) {
        super(plugin);
        this.setPermission(Permission.ZSHOP_LEVEL2_REMOVE);
        this.addSubCommand("remove");
        this.setDescription(Message.DESCRIPTION_LEVEL2_REMOVE);
    ...
    protected CommandType perform(ShopPlugin plugin) {
        ...
        message(plugin, sender, Message.LEVEL2_REMOVE_SUCCESS,
